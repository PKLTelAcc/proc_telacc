...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2018 at 08:56 AM
...
CREATE TABLE `survey` (
  ...
  `SURV_WODE_ID_TA` int(11) NOT NULL,
  `SURV_WODE_LOKASI` int(11) NOT NULL,
  `SURV_PEGA_NAME` int(11) NOT NULL,
  `SURV_PEGA_NIK` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(2, 'BDG2', 'Jalan Jalan', '008', 'Jalan Jalan', '2018-07-09', '2018-07-13 06:50:21', 1, 1, 1, 1);
...
--
ALTER TABLE `work_order`
  MODIFY `WODE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
