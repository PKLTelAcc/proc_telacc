	            ...
	            <form name="GantiPassword" action="<?php echo base_url ()?>C_profil/GantiPassword/" method="post">
		            ...
		            <div class="form-group">
		                <div class="row">
		                  ...
		                  <div class="col-md-2">
		                    <button type="submit" class="btn btn-danger pull-right" data-toggle="modal" data-target="#modal-success2" onclick="validatePassword()" id="submitPassword">GantiPassword</button>
		                  </div>
		                </div>
		              </div>
	             	</div>
