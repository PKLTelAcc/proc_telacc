	...
	<div class="row">
	  ...
	  <div class="col-md-12">
	    <div class="box box-danger">
	      ...
	      <!-- /.box-header -->
	      <div class="box-body">
			<table class="table table-bordered table-hover table-striped" id="LAPORANWo">
				<thead>
					<tr>
						<th>No</th>
						<th>ID TA</th>
	  ...
	  <div class="col-md-12">
	    <div class="box box-danger">
	      ...
	      <!-- /.box-header -->
	      <div class="box-body">
			<table class="table table-bordered table-hover table-striped" id="LAPORANSurv">
				<thead>
					<tr>
						<th>No</th>
						<th>ID TA</th>
...
<!-- SAMPAI SINI -->
				...
				<tbody>
					<?php
					$no=1;
		 				foreach ($dataReportByWitelStatusSurv as $row) {
		 					echo "<tr>";
		 					echo "<td>".$no."</td>";
		 					echo "<td>".$row['WODE_ID_TA']."</td>";
		 					echo "<td>".$row['WTEL_NAME']."</td>";
...
//SAMPAI SINI
	  ...
	  <div class="col-md-12">
	    <div class="box box-danger">
	      ...
	      <!-- /.box-header -->
	      <div class="box-body">
			<table class="table table-bordered table-hover table-striped" id="LAPORANInst">
				<thead>
					<tr>
						<th>No</th>
						<th>ID TA</th>
...
<!-- SAMPAI SINI -->
				...
				<tbody>
					<?php
					$no=1;
		 				foreach ($dataReportByWitelStatusInst as $row) {
...
<script type="text/javascript">
    $(function () {
        ...
        $('#LAPORANSurv').dataTable( {
          "bSort": false,
          dom:'B <"content-header" <"col-sm-2"l> f>tipH',
          buttons: [ 'excel' ]
        } );

        $('#LAPORANInst').dataTable( {
          "bSort": false,
          dom:'B <"content-header" <"col-sm-2"l> f>tipH',
          buttons: [ 'excel' ]
        } );
